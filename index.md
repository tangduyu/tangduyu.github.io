...
<li> <strong>Knowledge-enhanced pre-trained model</strong>. Develop K-Adapter with neural adapters to support continual knowledge infusion into pre-trained model (e.g. BERT). [<a href="https://github.com/microsoft/k-adapter">GitHub page</a>|<a href="https://arxiv.org/abs/2002.01808">paper</a>]</li>
<li> <strong>Knowledge-driven machine reasoning</strong>. Inject logic, symbolic, and evidence into neural models to support natural language understanding and generation problems. </li>
</ol>
